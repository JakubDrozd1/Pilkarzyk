...
export const APIS = [ChatMessagesApi, GroupInvitesApi, GroupsApi, GroupsUsersApi, MeetingsApi, MessagesApi, NotificationTokensApi, RankingsApi, ResetPasswordsApi, TokenApi, UsersApi, UsersMeetingsApi];
