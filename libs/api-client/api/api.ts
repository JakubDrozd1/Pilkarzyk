...
export const APIS = [ChatMessagesApi, GroupInvitesApi, GroupsApi, GroupsUsersApi, GuestsApi, MeetingsApi, MessagesApi, NotificationTokensApi, NotificationsApi, RankingsApi, ResetPasswordsApi, TeamsApi, TokenApi, UsersApi, UsersMeetingsApi];
