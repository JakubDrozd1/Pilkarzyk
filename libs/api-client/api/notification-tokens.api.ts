...
export class NotificationTokensApi {
  ...
  public addNotificationToken(
    requestParameters: AddNotificationTokenRequestParams,
    observe?: 'body',
  ...
  public addNotificationToken(
    ...
    const getNotificationTokenRequest =
      requestParameters.getNotificationTokenRequest;
  ...
  public deleteNotificationToken(
    requestParameters: DeleteNotificationTokenRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: undefined; context?: HttpContext }
  ): Observable<any>;
  ...
  public deleteNotificationToken(
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling deleteNotificationToken.'
      );
    }
    ...
    let localVarPath = `/api/notification-token/${this.configuration.encodeParam(
      {
        name: 'userId',
        value: userId,
        in: 'path',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getNotificationTokensFromUser(
    requestParameters: GetNotificationTokensFromUserRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public getNotificationTokensFromUser(
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling getNotificationTokensFromUser.'
      );
    }
