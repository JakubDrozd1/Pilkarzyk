...
export const APIS = [ChatMessagesApi, GroupInvitesApi, GroupsApi, GroupsUsersApi, MeetingsApi, MessagesApi, NotificationTokensApi, RankingsApi, ResetPasswordsApi, TeamsApi, TokenApi, UsersApi, UsersMeetingsApi];
