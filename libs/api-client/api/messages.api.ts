...
// @ts-ignore
import { GetTeamTableMessageRequest } from '../model/get-team-table-message-request';
// @ts-ignore
...
export interface UpdateTeamMessageAsyncRequestParams {
    getTeamTableMessageRequest?: GetTeamTableMessageRequest;
}
